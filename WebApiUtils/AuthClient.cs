...
namespace WebApiUtils
{
    public static class AuthClient
    {
        ...
        private static string ScopeName => "api";
        ...
        public static void SetApiAuth(WebApplicationBuilder builder)
        {
            builder.Services.AddAuthentication("Bearer")
                ...
                {
                    options.BackchannelHttpHandler = HttpClient.CreateHandler();
        ...
        public static void SetHttpAuth(System.Net.Http.HttpClient client)
        {
            var tempClient = new System.Net.Http.HttpClient(HttpClient.CreateHandler());
